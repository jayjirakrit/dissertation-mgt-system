...
// export async function GetReportByUserId(userId) {
//   return await fetch("http://localhost:3000/user_reports");;
// }

// export async function GetReportByUserIdDemo(userId) {
//   try {
//     // Fetch reports and user_reports
//     const [reportsResponse, userReportsResponse] = await Promise.all([
//       fetch("http://localhost:3000/reports"),
//       fetch("http://localhost:3000/user_reports"),
//     ]);

//     const reports = await reportsResponse.json();
//     const userReportsData = await userReportsResponse.json();
//     console.log(reports);
//     console.log(userReportsData);

//     // Combine reports and user_reports
//     const userReports = userReportsData
//       .filter((ur) => ur.user_id === userId)
//       .map((ur) => {
//         const report = reports.find((r) => r.id === ur.report_id);
//         return {
//           user_report_id: ur.user_report_id,
//           name: report ? report.name : "Unknown Report",
//           type: report ? report.type : "Unknown Type",
//           document: report.document,
//           grade: ur.grade,
//           time_stamp: ur.time_stamp,
//         };
//       });
//     console.log(JSON.stringify(userReports));
//     return userReports;
//   } catch (error) {
//     console.error("Errr fetching reports:", error);
//   }
// }
